...
In the preceding article, we comprehensively explored the implementation of the [Binary Search algorithm](https://takeuforward.org/data-structure/binary-search-explained/) and the [lower bound algorithm](https://takeuforward.org/arrays/implement-lower-bound-bs-2/). 
...
In this article, we will learn how to implement the upper bound algorithm using a slight modification of the [Binary Search algorithm](https://takeuforward.org/data-structure/binary-search-explained/). 
