...
Practice:[Solve Problem](https://takeuforward.org/plus/dsa/problems/aggressive-cows)
...
**Dry-run:** _Please refer to the_ [_video_](https://youtu.be/R_Mfw4ew-Vo) _for the dry-run._
...
![](https://static.takeuforward.org/wp/uploads/2023/07/Screenshot-2023-07-10-213804.png)
...
**Note:** _It is always the opposite polarity. Initially the pointer ‘high’ was in the ‘not-possible’ half and so it ends up in the ‘possible’ half. Similarly, ‘low’ was initially in the ‘possible’ part and it ends up in the ‘not-possible’ part._

**Note:** _Please make sure to refer to the_ [_video_](https://youtu.be/R_Mfw4ew-Vo) _and try out some test cases of your own to understand, how the pointer ‘high’ will be always pointing to the answer in this case. This is also the reason we have not used any extra variable here to store the answer._
